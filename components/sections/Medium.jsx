...
export class Medium extends React.Component{
  ...
  componentDidMount(){
    fetch('https://cbeardmedium.000webhostapp.com/medium_scraper.php', {mode:'cors'})
    .then((res)=>{
      return res.json();
    }).
    then((json_res)=>{
    ...
    return(<Section {...this.props}
      ...
      fixed_column={<SideBlock {...this.props}>
        <div className='meta-container'>
          ...
          <div className='section-subtitle'>Web Development tutorials,<br/>musings, and opinions</div>
        </div>
        </SideBlock>
      }
